...
```{r}
data_dir = "/Users/akhorgad/Desktop/MDL/RTD/scIsoquantMatrixBuilder_Results/PBMC_BioIVT_10x3p_500cells.genes-sc_matrix_from_isoquant/"
...
ggsave(filename='VlnPlot.png',path='/Users/akhorgad/Desktop/MDL/RTD/scIsoquantMatrixBuilder_Results', plot = last_plot())
...
plot1 + plot2
ggsave(filename='FeatureScatter.png',path='/Users/akhorgad/Desktop/MDL/RTD/scIsoquantMatrixBuilder_Results', plot = last_plot())
```
...
ggsave(filename='DimPlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())
...
ggsave(filename='ElbowPlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())
```
Generating UMAP :
```{r}
...
ggsave(filename='UMAP_DimPlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())

FeaturePlot(seurat_obj, features = c("nFeature_RNA"))
ggsave(filename='nFeature_RNA_FeaturePlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())

FeaturePlot(seurat_obj, features = c("nCount_RNA"))
ggsave(filename='nCount_RNA_FeaturePlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())

FeaturePlot(seurat_obj, features = c("percent.mt"))
ggsave(filename='percent_mt_FeaturePlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())
...
ggsave(filename='foi_VlnPlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())

FeaturePlot( seurat_obj, features = feature_ids)
ggsave(filename='foi_FeaturePlot.png',path='/Users/akhorgad/mdl-docs-external/_images/', plot = last_plot())
